...
export const playListData: Track[] = [
    {
        ...
        url: require('./Assets/audio/AgoraHills.mp3'),
      },
      {
        id: 2,
        ...
        url: require('./Assets/audio/Stargirl.mp3'),
      },
      {
        id: 3,
        title: 'Kesariya',
        ...
        url: require('./Assets/audio/HappierThanEver.mp3'),
      },
      {
        id: 4,
        title: 'Title Track',
        ...
        url: require('./Assets/audio/When_the_party s_over.mp3'),
      },
      {
        id: 5,
        title: 'Besharam Rang',
        ...
        url: require('./Assets/audio/VideoGames.m4a'),
      },
];
